...
export const SIGNATURE_PRACTICES = [
...
export const COURSES = [
  {
    title: "European Empires in Asia",
    role: "Instructor of Record",
    description:
      "Examines British, Dutch, and French imperialism across Asia, tracing how the movement of plants, agricultural knowledge, and ecological ideas shaped imperial systems.",
  },
  {
